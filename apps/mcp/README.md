...
This MCP server wraps the E2B Sandbox CLI (located in `../cli/`) and exposes each CLI command as an MCP tool. It provides one-to-one mappings, allowing LLMs to:
