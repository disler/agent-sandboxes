...
class SandboxForkAgent:
    ...
    def __init__(
        ...
        # Note: E2B_API_KEY is configured directly in working_dir/.mcp.json
        agent_env = {}

        # Add GitHub token (optional, for git push/PR functionality)
        ...
        self.options = ClaudeAgentOptions(
            ...
            mcp_servers=str(MCP_CONFIG_PATH.resolve()),  # Absolute path to .mcp.json
